...
player1=Player(100,100,color(0),100,3,p1Controls)
player2=Player(300,500,color(255,0,255),100,3,p2Controls)
    
def setup():
    this.surface.setTitle("PyProFencing")
    size(800,800)
    global f
...
def draw():
        ...
        textFont(f,16)            
        fill(0)                       
        text("Attack! Move with WASD and IJKL, move swords with Q/E and U/O",180,50)
